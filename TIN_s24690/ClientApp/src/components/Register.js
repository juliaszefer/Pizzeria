...
export default function Register({idAdres, basket, setBasket, user, setUser, english}){
    ...
    return (
        <div>
            ...
            {showRegUser && (
                <RegUser setUser={setUser} user={user} basket={basket} setBasket={setBasket} english={english} idOsoba={idOsoba}/>
            )}
        </div>
    );
}